...
import { X, Send, Calendar, User, Phone as PhoneIcon, MessageSquare, CheckCircle } from 'lucide-react';
    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
        ...
        <motion.div
          ...
          className="relative z-10 max-w-lg w-full glass-panel-gold rounded-3xl p-6 sm:p-8 shadow-2xl border border-[#C9A96E]/40"
        >
          <button
            onClick={onClose}
          ...
          {!submitted ? (
            ...
            <div className="text-center py-8 space-y-4">
              ...
              <button
                onClick={handleReset}
                className="bg-[#C9A96E] text-[#0B0B0B] font-semibold uppercase tracking-widest text-xs px-8 py-3.5 rounded-xl shadow-lg mt-4"
              >
                Close Window
              </button>
            </div>
