...
import { X, Check, ShieldCheck, HardDrive, BookOpen, Camera, Sparkles } from 'lucide-react';
    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
        ...
        <motion.div
          ...
          className="relative z-10 max-w-2xl w-full glass-panel-gold rounded-3xl p-6 sm:p-8 my-8 shadow-2xl border border-[#C9A96E]/40"
        >
          {/* Close Button */}
          <button
            onClick={onClose}
