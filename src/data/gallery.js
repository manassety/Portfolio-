/**
 * Portfolio Gallery Data for SETY VIDEOS AND MIXING LAB
 * 
 * Filter categories: ALL, WEDDINGS, CANDID, CINEMATIC, TRADITIONAL, DRONE, ALBUMS
 * Captions & titles accurately matched to the actual studio photography themes.
 */

export const galleryCategories = [
  { id: "ALL", label: "All Works" },
  { id: "WEDDINGS", label: "Weddings" },
  { id: "CANDID", label: "Candid Shots" },
  { id: "CINEMATIC", label: "Cinematic Stills" },
  { id: "TRADITIONAL", label: "Traditional" },
  { id: "DRONE", label: "Drone Aerials" },
...
export const galleryItems = [
  ...
  {
    id: 5,
    title: "Spontaneous Bridal Smile",
    category: "CANDID",
  ...
  {
    id: 10,
    title: "Monochrome Peacock Portrait",
    category: "CINEMATIC",
  ...
  {
    id: 11,
    title: "Stage Ceremony Highlights",
  ...
  {
    id: 12,
    title: "Handcrafted Red & Gold Album",
    category: "ALBUMS",
  ...
  {
    id: 14,
    title: "Custom Album Page Design",
    category: "ALBUMS",
    categoryLabel: "Albums & Frames",
    location: "Mixing Lab Studio",
    aspect: "landscape",
  ...
  {
    id: 16,
    title: "Grand Venue Aerial Vista",
    category: "DRONE",
